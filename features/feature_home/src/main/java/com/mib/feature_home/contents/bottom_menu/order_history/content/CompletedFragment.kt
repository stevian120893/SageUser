...
class CompletedFragment : BaseFragment<CompletedViewModel>(0) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(viewModel.isLoggedIn()) viewModel.getOrderHistory(this@CompletedFragment, DEFAULT_NEXT_CURSOR_REQUEST)
    }
    ...
    private fun initListener() {
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (!isLoadNextItem && size >= MAX_PAGINATION_ITEMS) {
                    if (AppUtils.isLastItemDisplaying(recyclerView)) {
                        nextCursor?.let {
                            viewModel.getOrderHistory(this@CompletedFragment, nextCursor.orEmpty())
        ...
        binding.srlHistory.setOnRefreshListener {
            viewModel.getOrderHistory(this@CompletedFragment, DEFAULT_NEXT_CURSOR_REQUEST)
        }
